...
<p align="center">
  ...
  <sub>交互式终端工具 + Python MCP 客户端 + 27 个 AI Skills，通过 MCP 调用全部 45 个 Amazon 数据工具</sub><br>
...
前往 [卖家精灵开放平台](https://open.sellersprite.com/pricing/mcp) 购买密钥，一价解锁 45 个 Amazon 数据工具：

| 周期     | 套餐  | 特惠价      | 原价        | 速率        | 月额度     | 用户数             |
|----------|-------|-------------|-------------|-------------|------------|--------------------|
| **月付** | Basic | **¥99**     | ¥199        | 40 次/分钟  | 1,000 次   | 1 个用户（密钥）   |
| 月付     | Pro   | **¥299**    | ¥599        | 40 次/分钟  | 4,000 次   | 1 个用户（密钥）   |
| 月付     | Max   | **¥599**    | ¥1,199      | 40 次/分钟  | 10,000 次  | 1 个用户（密钥）   |
| **季付** | Basic | **¥297**    | ¥597        | 40 次/分钟  | 1,000 次   | 1 个用户（密钥）   |
| 季付     | Pro   | **¥499**    | ¥999        | 40 次/分钟  | 4,000 次   | 1 个用户（密钥）   |
| 季付     | Max   | **¥990**    | ¥1,990      | 40 次/分钟  | 10,000 次  | 1 个用户（密钥）   |
| **年付** | Basic | **¥990**    | ¥1,990      | 40 次/分钟  | 4,000 次   | 1 个用户（密钥）   |
| 年付     | Pro   | **¥1,990**  | ¥3,999      | 60 次/分钟  | 10,000 次  | 3 个用户（密钥）   |
| 年付     | Max   | **¥2,990**  | ¥5,990      | 80 次/分钟  | 15,000 次  | 5 个用户（密钥）   |
